    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Sign in to save and load your signal processing projects.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Button
              type="button"
              variant="outline"
              className="w-full bg-[#4285F4] hover:bg-[#357ae8] text-white border-0"
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full bg-[#24292e] hover:bg-[#1b1f23] text-white border-0"
