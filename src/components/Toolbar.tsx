...
> = {
  ...
  merge: GitBranch,
  switch: ToggleRight,
  "ab-switch": FlipHorizontal,
  "sample-hold": Pause,
  comparator: Scale,
  panner: PanelLeftOpen,
  "stereo-splitter": Columns2,
  "stereo-merger": SplitSquareHorizontal,
  "and-gate": CircleSlash2,
  "or-gate": OrGate,
  "xor-gate": XorGate,
  "not-gate": CircleOff,
  "matrix-router": LayoutDashboard,
...
const blockGroups = [
  {
    title: "Inputs",
    blocks: ["slider", "multi-slider", "button", "toggle", "pulse", "keyboard", "beat-pad", "crossfader", "sequencer"] as BlockType[],
  },
  {
    title: "Generators",
    blocks: [
